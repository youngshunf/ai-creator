...
function ProjectCreatePage() {
  ...
  const handleArrayAdd = (
    ...
    inputField: keyof typeof tempInputs,
  ) => {
                ...
                <div className="flex gap-2 mb-2">
                  <input
                    ...
                    onKeyDown={(e) =>
                      e.key === "Enter" &&
                      (e.preventDefault(),
                      handleArrayAdd("sub_industries", "sub_industry"))
                    }
                  />
                  <button
                    type="button"
                  ...
                  {formData.sub_industries?.map((item, index) => (
                    ...
                    >
                      ...
                      <button
                        type="button"
                        onClick={() =>
                          handleArrayRemove("sub_industries", item)
                        }
              ...
              <div>
                ...
                <div className="flex gap-2 mb-2">
                  <input
                    ...
                    onKeyDown={(e) =>
                      e.key === "Enter" &&
                      (e.preventDefault(), handleArrayAdd("topics", "topic"))
                    }
                  />
                  <button
                    type="button"
                ...
                <div className="flex flex-wrap gap-2">
                  {formData.topics?.map((item, index) => (
                    <span
                      key={index}
                      className="px-3 py-1 bg-green-50 text-green-600 rounded-full text-sm flex items-center"
                    >
                      {item}
                      <button
                        type="button"
                        onClick={() => handleArrayRemove("topics", item)}
                        className="ml-2"
                      >
                        <X className="w-3 h-3" />
                      </button>
              ...
              <div>
                ...
                <div className="flex gap-2 mb-2">
                  <input
                    ...
                    onKeyDown={(e) =>
                      e.key === "Enter" &&
                      (e.preventDefault(),
                      handleArrayAdd("preferred_platforms", "platform"))
                    }
                  />
                  <button
                    type="button"
                ...
                <div className="flex flex-wrap gap-2">
                  {formData.preferred_platforms?.map((item, index) => (
                    <span
                      key={index}
                      className="px-3 py-1 bg-orange-50 text-orange-600 rounded-full text-sm flex items-center"
                    >
                      {item}
                      <button
                        type="button"
                        onClick={() =>
                          handleArrayRemove("preferred_platforms", item)
                        }
                        className="ml-2"
                      >
                        <X className="w-3 h-3" />
